        ...
        var results = this.state.searchResults.map((result, i) => {
            return <div className="col-sm-3 home-middle-middle-search-review" key={i}>
                    <div className="col-sm-12">
                        ...
                        <img height="200"  src={result.photo.length?'https://maps.googleapis.com/maps/api/place/photo?maxwidth=800&photoreference=' + result.photo[0].photo_reference + '&key=' + result.photo[0].api_key :'https://unsplash.it/300?image=835'} alt="" />
                    </div>
                    <div className="col-sm-12">
