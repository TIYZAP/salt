...
class Review extends React.Component{
    ...
    componentWillMount(){
        ...
        .then(response => this.setState({
            ...
            photo: (response.photos && response.photos.length? 'https://maps.googleapis.com/maps/api/place/photo?maxwidth=800&photoreference=' + response.photos[0].photo_reference + '&key=' + response.photos[0].api_key :'https://unsplash.it/300?image=835')
        }))
    }
    submitReview(){
                      ...
                      <div className="col-sm-12 post-review">
                          <div className="row">
                              <div className="col-sm-5">
                                <img height="300" width="300" src={this.state.searchResults.photos && this.state.searchResults.photos.length? 'https://maps.googleapis.com/maps/api/place/photo?maxwidth=800&photoreference=' + this.state.searchResults.photos[0].photo_reference + '&key=' + this.state.searchResults.photos[0].api_key :'https://unsplash.it/300?image=835'} alt="" />
